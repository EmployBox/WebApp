...
//        }
        ...
        return () -> SQLUtils.executeSQLQuery(
                query,
                this::mapper,
                statement -> {
                    try{
    ...
    private void handleCRUD(MapperSettings mapperSettings, T obj){
        if(mapperSettings.isProcedure())
            SQLUtils.executeSQLProcedure(mapperSettings.getQuery(), obj, mapperSettings.getStatementConsumer());
        else
            SQLUtils.executeSQLUpdate(mapperSettings.getQuery(), obj, mapperSettings.getStatementConsumer());
    }
