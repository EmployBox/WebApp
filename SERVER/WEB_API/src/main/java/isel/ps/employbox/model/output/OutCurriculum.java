...
public class OutCurriculum extends OutputDto {
    ...
    private class _Links{
        ...
        private class Projects {
            @JsonProperty
            final String href = HOSTNAME + linkTo ( methodOn(CurriculumController.class).getProjects(userId,curriculumId, 0)).withRel("projects").getHref();
        }

        private class AcademicBackgrounds {
            @JsonProperty
            final String href = HOSTNAME + linkTo ( methodOn(CurriculumController.class).getAcademicBackground(userId,curriculumId, 0)).withRel("academicBackground").getHref();
        }
