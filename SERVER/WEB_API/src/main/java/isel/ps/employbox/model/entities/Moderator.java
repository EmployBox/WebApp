...
public class Moderator extends Account {
    ...
    public Moderator(long accountID, String email, String password, float rating, long version, Supplier<List<Comment>> comments, Supplier<List<Chat>> chats, Supplier<List<Rating>> ratings,
