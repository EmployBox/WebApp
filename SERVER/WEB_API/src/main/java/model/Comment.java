...
public class Comment extends AutoGeneratedIdentity {
    ...
    private Comment(long commentID, long accountIdFrom, long accountIdTo, long parentCommendID, Date date, String text, boolean status, long version){
    ...
    public static Comment create (
                                ...
                                boolean status)
    {
        Comment comment = new Comment(defaultKey, accountIdFrom, accountIdTo, parentCommendID, date , text, status, 0);
        comment.markNew();
        return comment;
    }
