...
public class Account extends AutoGeneratedIdentity {
    ...
    public static Account update(Account acc, long accountID, String email, String password, double rating){
        acc.markToBeDirty();
        Account account = new Account(accountID, email, password, rating, acc.getNextVersion());
        account.markDirty();
        return account;
    }
